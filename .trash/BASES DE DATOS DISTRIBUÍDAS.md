...
> [!info] Normalización de Bases de Datos  
> En este recurso educativo se abordan aspectos conceptuales básicos relacionados con las formas de normalización, generalmente utilizadas en el análisis, desarrollo e implementación de sistemas de bases de datos.  
> [https://programas.cuaed.unam.mx/repositorio/moodle/pluginfile.php/872/mod_resource/content/7/Contenido/index.html](https://programas.cuaed.unam.mx/repositorio/moodle/pluginfile.php/872/mod_resource/content/7/Contenido/index.html)  
---
...
- **Reglas de una BBDD**
    ...
    $$Función Costo = Costo E/S + CostoProcesamiento + CostoComunicación$$
...
Se posiciona los nodos de las tablas
||**N1**|**N2**|**N3**|
|---|---|---|---|
|**.**  <br>**.**  <br>**.**||||
|**sede n**|T1|T1|T1|
